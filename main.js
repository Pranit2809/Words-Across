...
row = "<div class='room_name' id ="+Room_names+" onclick='redirectToRoomName(this.id)' style='background-color:rgb(225, 189, 151); border-radius:50px;        text-decoration: underline;''>#"+Room_names+"</div><hr>";
